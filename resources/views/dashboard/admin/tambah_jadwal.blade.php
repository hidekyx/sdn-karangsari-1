<div class="col-md-12 grid-margin stretch-card">
    ...
    <div class="card-body">
        ...
        <p class="card-description">Isikan informasi data jadwal untuk guru - {{ $guru->nama }}</p>
        <form role="form" action="{{ asset('/dashboard/guru/jadwal/store/'.$guru->id_user) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="id_pelajaran" name="id_pelajaran" style="color:#000" required>
                    <option disabled selected hidden>-- Piilh Pelajaran --</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="hari" name="hari" style="color:#000" required>
                    <option disabled selected hidden>-- Piilh Hari --</option>
